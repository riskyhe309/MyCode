...
public class Get_Dict_Word {
    ...
    public static void getSentiment() throws IOException {
        ...
        //the candidate words
        // String input2 = "C:/Users/Risky/Downloads/dataset_602156/wordSet/result/1/candidate1/candidateWords2.txt";

        //getWordMap(candidates, input2);

        // allWord = negMap.size() + posMap.size() + candidates.size();

      /*  String outputNeg = "C:/Users/Risky/Downloads/dataset_602156/wordSet/result/1/wordSetNeg1.txt";
        BufferedWriter bwNeg = new BufferedWriter(new FileWriter(new File(outputNeg)));
        // bwNeg.newLine();

        String outputPos = "C:/Users/Risky/Downloads/dataset_602156/wordSet/result/1/wordSetPos1.txt";
...
/*
            ...
            //compute the SO_PMI
            double so_PMI = Math.log((posNum * totalNeg) / (negNum * totalPos));
